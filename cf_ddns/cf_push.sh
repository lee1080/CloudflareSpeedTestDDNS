...
if [[ -z ${Proxy_WX} ]]; then
   tgapi="https://qyapi.weixin.qq.com"
else
   tgapi=$Proxy_WX
fi

TGURL="$Proxy_TG/bot${telegramBotToken}/sendMessage"
PushDeerURL="https://api2.pushdeer.com/message/push?pushkey=${PushDeerPushKey}"
WX_tkURL="$Proxy_WX/cgi-bin/gettoken"
WXURL="$Proxy_WX/cgi-bin/message/send?access_token="
